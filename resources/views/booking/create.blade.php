                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div class="flex flex-col gap-2">
                                <label for="nama_lengkap"
                                    class="text-xs font-bold text-zinc-500 uppercase tracking-widest">Nama Lengkap</label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="flex flex-col gap-2">
                                    <label for="no_wa"
                                        class="text-xs font-bold text-zinc-500 uppercase tracking-widest">No.
                                        WhatsApp</label>
                                    <input type="text" name="no_wa" id="no_wa" required placeholder="08..."
                                        pattern="^08[0-9]*$" title="Nomor WhatsApp harus diawali dengan 08"
                                        value="{{ old('no_wa') }}"
                                        class="w-full border border-zinc-300 rounded-sm p-3 focus:outline-none focus:border-zinc-900 transition-colors">
                                ...
                                <div class="flex flex-col gap-2">
                                    <label for="no_ktp_sim"
                                        class="text-xs font-bold text-zinc-500 uppercase tracking-widest">No. KTP /
                                        SIM</label>
                                    <input type="text" name="no_ktp_sim" id="no_ktp_sim" required
                                        value="{{ old('no_ktp_sim') }}"
                                        class="w-full border border-zinc-300 rounded-sm p-3 focus:outline-none focus:border-zinc-900 transition-colors">
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col gap-2">
                                <label for="email"
                                    class="text-xs font-bold text-zinc-500 uppercase tracking-widest">Email (Untuk
                                    Login)</label>
                                <input type="email" name="email" id="email" required
                                    placeholder="alamat@email.com" value="{{ old('email') }}"
                                    class="w-full border border-zinc-300 rounded-sm p-3 focus:outline-none focus:border-zinc-900 transition-colors">
                                <p class="text-[10px] text-zinc-400 mt-1">Gunakan email aktif untuk memantau status sewa
                                    Anda.</p>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="flex flex-col gap-2">
                                    <label for="password"
                                        class="text-xs font-bold text-zinc-500 uppercase tracking-widest">Password</label>
                                ...
                                <div class="flex flex-col gap-2">
                                    <label for="password_confirmation"
                                        class="text-xs font-bold text-zinc-500 uppercase tracking-widest">Konfirmasi
                                        Password</label>
                            ...
                            <div class="flex flex-col gap-2">
                                <label for="alamat_asal"
                                    class="text-xs font-bold text-zinc-500 uppercase tracking-widest">Alamat Asal</label>
                                <textarea name="alamat_asal" id="alamat_asal" rows="3"
                                    class="w-full border border-zinc-300 rounded-sm p-3 focus:outline-none focus:border-zinc-900 transition-colors"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
